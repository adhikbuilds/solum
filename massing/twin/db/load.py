...
The dated snapshot, into Postgres.
    ...
    python -m twin.db.load                 # newest snapshot for the configured AOI
    python -m twin.db.load --aoi dubai-all --warm
...
from twin.pipeline.city import (                                       # noqa: E402
    _clean, _height, _mass_one, _rings, _value, PRECISION,
)
from twin.sources import parcels                                       # noqa: E402
...
def load(dsn: str, aoi: str, *, warm: bool = False) -> int:
    ...
    print('· committed')
    if warm:
        from twin.db.tiles import warm as warm_tiles
        warm_tiles(dsn, aoi)
    return 0
