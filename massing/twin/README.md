...
```bash
cd massing
python -m twin.pipeline.build             # live DDA + OSM over the AOI in config/dubai.json
python -m twin.pipeline.build --fixture   # offline, from the checked-in parcel response
