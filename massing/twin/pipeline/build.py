...
from solum_massing.dda import SQFT_PER_SQM, Provenance     # noqa: E402
from solum_massing.solid import shrink_to_area             # noqa: E402

from twin.model import config as cityconfig, value
from twin.sources import osm as buildings, parcels as acquire      # noqa: E402
from twin.model.geometry import parcel_geometry                  # noqa: E402
from twin.model.heights import Height, resolve                   # noqa: E402
from twin.sources.imagery import _TO_WGS84, district_tiles         # noqa: E402
from twin.model.sun import default_moment, scene_direction, solar_position   # noqa: E402
from twin.model.schema import Manifest, Parcel, Rejected, Stats   # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument('--fixture', action='store_true',
                    help='build offline from massing/fixtures/parcel-3156315.json')
    ...
    if args.fixture:
        fixture = Path(__file__).resolve().parents[3] / 'fixtures' / 'parcel-3156315.json'
