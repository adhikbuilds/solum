...
from solum_city.pipeline.build import bake
from solum_city.model.heights import resolve
...
def test_osm_height_tags_beat_the_plot_ceiling(cfg):
    from solum_city.sources import osm as buildings
...
def test_the_reference_plot_prices(features):
    from solum_city.model.value import appraise_feature
